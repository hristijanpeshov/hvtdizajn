...
//    }
    ...
    public String listAll(Model model)
    {
        ...
        ResponseEntity<MoneyObject[]> responseEntity = restTemplate.getForEntity("http://MONEY-OBJECT-SERVICE/admin", MoneyObject[].class);
        Object[] objects = responseEntity.getBody();
    ...
    public String save(@RequestParam String name, @RequestParam Type type, @RequestParam double lon, @RequestParam double lat)
    {
        ...
        sendRequest("http://MONEY-OBJECT-SERVICE/admin/create",request);
